...
const Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<body class="svelte-1gnzo0w" data-svelte-h="svelte-24zhb5"><nav class="navbar navbar-expand-lg"><div class="container-fluid"><a href="/"><img src="/gold-cross.png" alt="Golden Cross"></a> <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button> <div class="collapse navbar-collapse" id="navbarNavAltMarkup"><div class="navbar-nav"><a class="nav-link active svelte-1gnzo0w" href="/about">About</a> <a class="nav-link active svelte-1gnzo0w" href="/recruitment">Recruitment</a></div></div></div></nav> </body>`;
});
